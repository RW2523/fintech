"""T-008 — lmi answers the platform's meta endpoints."""
...
async def _client() -> AsyncClient:
    return AsyncClient(transport=ASGITransport(app=app), base_url="http://lmi")
