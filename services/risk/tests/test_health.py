"""T-008 — risk answers the platform's meta endpoints."""
...
async def _client() -> AsyncClient:
    return AsyncClient(transport=ASGITransport(app=app), base_url="http://risk")
...
async def test_health_reports_ok_with_the_service_name() -> None:
    ...
    assert body == {"status": "ok", "service": "risk", "version": "0.1.0"}
