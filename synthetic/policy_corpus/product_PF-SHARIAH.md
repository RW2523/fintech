...
doc: product_PF-SHARIAH
---

# Personal Financing — Murabahah (PF-SHARIAH)

This sheet describes Personal Financing — Murabahah as it stands in version 2026.09.1, effective 2026-09-01. Every clause id below is the id the decision engine evaluates, so a decision that cites a clause can be checked against the rule that ran.
...
| structure | MURABAHAH |
| markup rate | 0.07 |
| instalment formula | amount * (1 + markup_rate * tenor / 12) / tenor |
| min share units | 100 |
| purposes allowed | PERSONAL, EDUCATION, MEDICAL, HOME_IMPROVEMENT, VEHICLE |
