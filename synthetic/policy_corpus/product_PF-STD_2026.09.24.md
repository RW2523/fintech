...
This sheet describes Personal Financing — Standard as it stands in version 2026.09.24, effective 2026-09-01. Every clause id below is the id the decision engine evaluates, so a decision that cites a clause can be checked against the rule that ran.
